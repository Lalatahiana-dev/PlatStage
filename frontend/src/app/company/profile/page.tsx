...
export default function CompanyProfilePage() {
  ...
  try {
    ...
    if (err && typeof err === 'object' && 'response' in err) {
      ...
      console.error('Erreur update profile:', JSON.stringify(axiosErr.response.data));
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-800 mb-1">Profil entreprise</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-6 text-center h-fit">
          ...
          <h3 className="text-base font-semibold text-gray-800">{profile?.company_name}</h3>
          ...
          <div className="text-left bg-gray-50 rounded-lg p-3 text-xs text-gray-500 space-y-2 mt-4">
            {profile?.website && (
              <div className="flex items-center gap-2">
                ...
                <a href={profile.website} target="_blank" rel="noopener noreferrer" className="text-indigo-500 hover:underline truncate">
                  {profile.website}
                </a>
              </div>
            )}
        ...
        <div className="lg:col-span-2">
          <div className="bg-white border border-gray-100 rounded-xl p-6">
            <h3 className="text-base font-semibold text-gray-800 mb-4">Informations entreprise</h3>
